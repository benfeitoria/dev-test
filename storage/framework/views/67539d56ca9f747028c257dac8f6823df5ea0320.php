<?php $__env->startSection('content'); ?>
  <pagina tamanho="12">
    ...
    <painel titulo="Lista de Usuários">
      ...
      criar="#criar" detalhe="/admin/usuarios/" editar="/admin/usuarios/" deletar="/admin/usuarios/" token="<?php echo e(csrf_token()); ?>"
      modal="sim"
  ...
  <modal nome="editar" titulo="Editar">
    <formulario id="formEditar" v-bind:action="'/admin/usuarios/' + $store.state.item.id" method="put" enctype="" token="<?php echo e(csrf_token()); ?>">
